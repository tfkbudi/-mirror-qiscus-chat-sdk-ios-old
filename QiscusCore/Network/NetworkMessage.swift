...
extension NetworkManager {
    ...
    func postComment(roomId: String, type: String = "text", message: String, payload: String? = "", extras: String? = "", uniqueTempId: String = "", completion: @escaping(CommentModel?, String?) -> Void) {
